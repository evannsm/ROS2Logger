...
I recommend for basic use to clone like this: (gets rid of `.git` and gives you both directories you need right where you intended them, not inside the git ROS2Logger directory). I may split these into two repos soon but that feels a bit much right now
```bash
